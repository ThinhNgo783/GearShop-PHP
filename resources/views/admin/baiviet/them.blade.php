...
@section('content')
<div class="card">
    <div class="card-header"><b>Thêm bài viết</b></div>
    <div class="card-body">
        <form action="{{ route('admin.baiviet.them') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('tomtat') is-invalid @enderror" id="tomtat" name="tomtat">{{ old('tomtat') }}</textarea>
                @error('tomtat')
                <div class="invalid-feedback"><strong>{{ $message }}</strong></div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <textarea class="form-control @error('noidung') is-invalid @enderror" id="noidung" name="noidung">{{ old('noidung') }}</textarea>
                @error('noidung')
                <div class="invalid-feedback"><strong>{{ $message }}</strong></div>
                @enderror
            </div>
